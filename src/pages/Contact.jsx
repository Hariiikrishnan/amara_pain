  ...
  return (
    <div className="w-full py-16 px-4 md:px-8 max-w-7xl mx-auto space-y-16 text-left">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            {/* Phone & Fax Card */}
            <Card variant="white" padding="md" className="border-slate-100 shadow-premium flex gap-4 items-start">
              <Phone className="h-6 w-6 text-medical-600 shrink-0 mt-1" />
              <div>
                <h3 className="font-bold text-sm text-primary-900 uppercase tracking-wider">Phone &amp; Fax</h3>
            ...
            <Card variant="white" padding="md" className="border-slate-100 shadow-premium flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-bold text-sm text-primary-900 uppercase tracking-wider">Location Address</h3>
            ...
            <Card variant="white" padding="md" className="border-slate-100 shadow-premium flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-bold text-sm text-primary-900 uppercase tracking-wider">Office Hours</h3>
                <p className="text-sm text-slate-500 leading-relaxed mt-1">
            ...
            <Card variant="white" padding="md" className="border-slate-100 shadow-premium flex gap-4 items-start">
              ...
              <div>
                <h3 className="font-bold text-sm text-primary-900 uppercase tracking-wider">Administrative Email</h3>
                <a href="mailto:amarapain@gmail.com" className="block text-sm text-slate-500 hover:text-medical-600 mt-1">
                  amarapain@gmail.com
                </a>
              </div>
            </Card>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <Card variant="white" padding="lg" className="border-slate-100 shadow-2xl relative">
            {submitSuccess ? (
              <div className="text-center py-12 space-y-4">
                ...
                <h3 className="text-2xl font-bold font-heading text-primary-900">Inquiry Sent Successfully</h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:border-medical-600 focus:ring-1 focus:ring-medical-600"
                    />
                  </div>
      ...
      <section className="space-y-8 pt-6">
        <h2 className="text-3xl font-black font-heading tracking-tight text-primary-900 text-center">
          Location Map &amp; Driving Directions
        </h2>

        {/* Mock/Styled Google Map Card */}
        <Card variant="white" padding="none" className="border-slate-100 shadow-premium overflow-hidden aspect-[21/9] w-full bg-slate-200 relative group">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-medical-50/20 via-slate-100 to-slate-200 flex items-center justify-center p-6 text-center">
            <div className="space-y-4 max-w-md">
              <div className="p-3 bg-white text-medical-600 rounded-2xl shadow-md w-14 h-14 flex items-center justify-center mx-auto">
                <MapPin className="h-7 w-7 animate-bounce" />
              </div>
              <div className="space-y-1">
                <h4 className="font-black text-lg text-primary-900">Amara Pain &amp; Spine Management</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <Card variant="white" padding="md" className="border-slate-100 shadow-premium space-y-4">
            <div className="flex items-center gap-2 text-medical-600 border-b border-slate-50 pb-2">
              <Car className="h-5 w-5" />
              <h3 className="font-bold text-base text-primary-900 font-heading">Driving Directions</h3>
            </div>
          ...
          <Card variant="white" padding="md" className="border-slate-100 shadow-premium space-y-4">
            <div className="flex items-center gap-2 text-accent-600 border-b border-slate-50 pb-2">
              <Bus className="h-5 w-5" />
              <h3 className="font-bold text-base text-primary-900 font-heading">CATS Bus Routes</h3>
            </div>
            <p className="text-xs text-slate-500 leading-relaxed">
          ...
          <Card variant="white" padding="md" className="border-slate-100 shadow-premium space-y-4">
            <div className="flex items-center gap-2 text-slate-500 border-b border-slate-50 pb-2">
              <Navigation className="h-5 w-5" />
              <h3 className="font-bold text-base text-primary-900 font-heading">Uber, Lyft, &amp; Taxi</h3>
            </div>
            <p className="text-xs text-slate-500 leading-relaxed">
